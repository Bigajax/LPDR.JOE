  ...
  return (
    <section style={{ padding: "7rem 2rem 6rem", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        background: `
          radial-gradient(ellipse 70% 50% at 80% 10%, rgba(148,136,196,0.10) 0%, transparent 55%),
          radial-gradient(ellipse 50% 60% at 10% 90%, rgba(196,152,60,0.06) 0%, transparent 50%),
          linear-gradient(155deg, #F2EBE0 0%, #ede6d8 50%, #f0eaf8 100%)
        `,
      }} />
      ...
      <div style={{ maxWidth: 1060, margin: "0 auto", position: "relative", zIndex: 2 }}>
        ...
        <div className="steps-grid" style={{ marginBottom: "4rem", position: "relative" }} data-stagger>
          ...
          <div className="steps-connector" style={{
            ...
            height: 1,
            background: "linear-gradient(90deg, rgba(28,20,40,0.15), rgba(148,136,196,0.30), rgba(28,20,40,0.15))",
            pointerEvents: "none",
          }} />
          ...
          {steps.map((step) => (
            ...
            >
              ...
              <p className="font-mono" style={{ fontSize: "0.6875rem", color: "rgba(148,136,196,0.80)", textTransform: "uppercase", letterSpacing: "0.15em", marginBottom: "0.75rem" }}>
                {step.label}
              </p>
