...
export default function Hero() {
  return (
    ...
    >
      ...
      >
        ...
        <div className="hero-copy">
          ...
          <div className="hero-eyebrow" style={{ marginBottom: "1.75rem" }}>
            <span className="font-mono" style={{
              ...
              <span>Mais de 2.400 pessoas</span>
              <span style={{ width: 1, height: 10, background: "rgba(148,136,196,0.30)", display: "inline-block" }} />
              <span style={{ color: "rgba(196,152,60,0.80)", letterSpacing: "0.16em", textTransform: "uppercase", fontSize: 9 }}>Método Dispenza</span>
            </span>
          </div>
          ...
          <h1
            ...
            style={{
              ...
              color: "#f5f0ff", maxWidth: 700, marginBottom: 20,
            }}
          >
            Sua mente quer mudar.
            <br />
            <span style={{
              ...
              Mas seu corpo ainda vive no passado.
            </span>
          </h1>
          ...
          <p style={{
            ...
            color: "rgba(210,205,230,0.90)", lineHeight: 1.72,
          ...
          <p style={{
            ...
            color: "rgba(192,180,224,0.72)", lineHeight: 1.65,
            maxWidth: 400, marginBottom: "2rem",
            fontFamily: "var(--font-body)", fontWeight: 500,
          }}>
            Não é força de vontade. Não é disciplina. É neurologia — e você pode reprogramar isso.
          </p>

          {/* PRIMARY CTA */}
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: "0.75rem" }} className="cta-group">
            <CheckoutButton
              label="Criar minha nova realidade — R$ 37"
              className="hero-cta"
              style={{ fontSize: "1.0rem", padding: "1.125rem 2.5rem" }}
            />
            <p className="font-mono" style={{
              fontSize: "0.6875rem", color: "rgba(192,180,224,0.55)", letterSpacing: "0.12em",
            }}>
              Acesso imediato · Sem assinatura · Funciona no celular
            </p>
          </div>
          ...
          <div className="hero-pills" style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", marginTop: "2rem", marginBottom: "2.75rem" }}>
            {[
              ...
              { label: "5 a 7 min por dia",  icon: "◷" },
              { label: "Acesso vitalício",   icon: "⟡" },
            ].map(({ label, icon }) => (
              <span key={label} className="font-mono" style={{
                ...
                background: "rgba(148,136,196,0.07)", border: "1px solid rgba(148,136,196,0.22)",
          ...
          <div style={{ marginTop: "2rem", display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <p className="font-mono" style={{ fontSize: "0.6563rem", color: "rgba(192,180,224,0.55)", letterSpacing: "0.10em" }}>
              Baseado na metodologia do Dr. Joe Dispenza — neurocientista, autor e palestrante mundial.
            </p>
          </div>
        </div>
        ...
        <div className="hero-visual" style={{ position: "relative", display: "flex", justifyContent: "center", alignItems: "center" }}>
          <div className="hero-orbit hero-orbit-1" style={{
            position: "absolute", width: "clamp(280px, 38vw, 500px)", height: "clamp(280px, 38vw, 500px)",
          ...
          <div className="hero-orbit hero-orbit-2" style={{
            position: "absolute", width: "clamp(200px, 28vw, 380px)", height: "clamp(200px, 28vw, 380px)",
          ...
          <div className="hero-glow" style={{
            position: "absolute", width: "clamp(240px, 32vw, 420px)", height: "clamp(240px, 32vw, 420px)", borderRadius: "50%",
            background: "radial-gradient(circle, rgba(120,100,200,0.18) 0%, rgba(100,80,180,0.08) 45%, transparent 70%)",
            top: "50%", left: "50%", transform: "translate(-50%,-50%)", pointerEvents: "none", filter: "blur(2px)",
          }} />
          ...
          <div className="testimonial-card" style={{
            ...
            padding: "1rem 1.25rem", width: 220,
          ...
          <div className="stat-card" style={{
            ...
            background: "rgba(8,5,20,0.88)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)",
            border: "1px solid rgba(196,152,60,0.22)", borderRadius: 12,
            padding: "0.9rem 1.25rem", zIndex: 3, textAlign: "center",
            boxShadow: "0 12px 40px rgba(0,0,0,0.50), 0 0 0 1px rgba(196,152,60,0.06)",
          }}>
            <p className="font-display gold-text" style={{ fontSize: "1.75rem", fontWeight: 700, lineHeight: 1, display: "block" }}>R$ 37</p>
            <p className="font-mono" style={{ fontSize: 9, color: "rgba(192,180,224,0.72)", letterSpacing: "0.12em", textTransform: "uppercase", marginTop: 5 }}>
              acesso<br />vitalício
            </p>
          </div>
        </div>
      ...
      <style>{`
        @keyframes hero-shine { 0% { background-position: 220% center; } 100% { background-position: -220% center; } }
        ...
        @media (max-width: 600px) {
          ...
          .hero-grid h1 { font-size: clamp(32px, 9vw, 44px) !important; line-height: 1.12 !important; margin-bottom: 18px !important; }
          .cta-group { gap: 0.75rem !important; }
          .hero-pills { justify-content: center; }
          .hero-cta { width: min(520px, 100%) !important; justify-content: center; padding: 1.05rem 1.5rem !important; font-size: 0.9375rem !important; }
          ...
          .testimonial-card { position: relative !important; left: auto !important; bottom: auto !important; transform: none !important; width: min(360px, 92vw) !important; margin: 14px auto 0 !important; }
        }
      `}</style>
    </section>
  );
